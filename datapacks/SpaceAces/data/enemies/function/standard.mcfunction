...
execute if score @s[tag=canSee] i matches 50.. facing entity @e[tag=!invis,sort=nearest,limit=1,team=blue] feet run function enemies:shoot
...
execute facing entity @e[tag=!invis,sort=nearest,limit=1,team=blue] feet run tp @s ~ ~ ~ ~ ~
