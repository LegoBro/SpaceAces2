...
tellraw @a ["",{"text":"[","color":"dark_gray","bold":true,"type":"text"},{"text":"All players ready, mission startup engaged","color":"gray","clickEvent":{"action":"run_command","value":"/trigger worm_hole set 1"},"bold":false,"type":"text"},{"text":"]","color":"dark_gray","type":"text"}]
