...
data modify block 9 195 5 front_text.messages[1] set value {text:"[Exit]",color:"dark_red","bold":true,click_event:{"action":"run_command",command:"/function gamemode:exit_team_selection"},"type":"text"}
setblock 7 195 5 minecraft:oak_wall_sign[facing=west]
data modify block 7 195 5 front_text.messages[1] set value {text:"[Exit]",color:"dark_red","bold":true,click_event:{"action":"run_command",command:"/function gamemode:exit_team_selection"},"type":"text"}
