...
setblock 29911 15 50 minecraft:oak_wall_sign[facing=north]{front_text:{messages:['',{translate:"unlock",click_event:{"action":"run_command",command:"/function gamemode:escape/purchase/mess_hall"}}',{translate:"mess_hall"},{text:"30 Energy",color:"green","type":"text"}]}} replace
...
setblock 29907 15 28 minecraft:oak_wall_sign[facing=east]{front_text:{messages:['',{translate:"unlock",click_event:{"action":"run_command",command:"/function gamemode:escape/purchase/barracks"}}',{translate:"barracks"},{text:"35 Energy",color:"green","type":"text"}]}} replace
...
setblock 29915 15 22 minecraft:oak_wall_sign[facing=west]{front_text:{messages:['',{translate:"unlock",click_event:{"action":"run_command",command:"/function gamemode:escape/purchase/tech"}}',{translate:"tech"},{text:"30 Energy",color:"green","type":"text"}]}} replace
setblock 29931 15 14 minecraft:oak_wall_sign[facing=north]{front_text:{messages:['',{translate:"unlock",click_event:{"action":"run_command",command:"/function gamemode:escape/purchase/tech"}}',{translate:"tech"},{text:"30 Energy",color:"green","type":"text"}]}} replace
...
setblock 29991 15 -45 minecraft:oak_wall_sign[facing=west]{front_text:{messages:['',{translate:"unlock",click_event:{"action":"run_command",command:"/function gamemode:escape/purchase/hallway"}}',{translate:"hallway"},{text:"50 Energy",color:"green","type":"text"}]}} replace
