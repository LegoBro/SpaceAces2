...
execute if block 29916 15 22 minecraft:barrier run setblock 29929 15 43 minecraft:oak_wall_sign[facing=south]{front_text:{messages:['',{translate:"unlock",click_event:{"action":"run_command",command:"/function gamemode:escape/purchase/tech"}}',{translate:"tech"},{text:"30 Energy",color:"green","type":"text"}]}} replace
