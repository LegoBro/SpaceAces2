...
setblock 30003 1 -14 minecraft:oak_wall_sign[facing=west]{front_text:{messages:['""','{"translate":"unlock","clickEvent":{"action":"run_command","value":"/function gamemode:escape/purchase/lab"}}','{"translate":"lab"}','{"text":"3 Energy","color":"green","type":"text"}']}} replace
setblock 30000 1 -37 minecraft:oak_wall_sign[facing=south]{front_text:{messages:['""','{"translate":"unlock","clickEvent":{"action":"run_command","value":"/function gamemode:escape/purchase/lab"}}','{"translate":"lab"}','{"text":"3 Energy","color":"green","type":"text"}']}} replace
...
setblock 29997 1 -14 minecraft:oak_wall_sign[facing=east]{front_text:{messages:['""','{"translate":"unlock","clickEvent":{"action":"run_command","value":"/function gamemode:escape/purchase/hangar"}}','{"translate":"hangar"}','{"text":"5 Energy","color":"green","type":"text"}']}} replace
