...
setblock 29997 1 56 minecraft:oak_wall_sign[facing=west]{front_text:{messages:['',{translate:"unlock",click_event:{"action":"run_command",command:"/function gamemode:escape/purchase/closet"}}',{translate:"closet"},{text:"50 Energy",color:"green","type":"text"}]}} replace
...
setblock 29929 1 31 minecraft:oak_wall_sign[facing=east]{front_text:{messages:['',{translate:"unlock",click_event:{"action":"run_command",command:"/function gamemode:escape/purchase/hall1"}}',{translate:"hall1"},{text:"10 Energy",color:"green","type":"text"}]}} replace
