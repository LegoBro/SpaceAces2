...
setblock 29998 15 -38 minecraft:oak_wall_sign[facing=west]{front_text:{messages:['',{translate:"unlock",click_event:{"action":"run_command",command:"/function gamemode:escape/purchase/training"}}',{translate:"training"},{text:"50 Energy",color:"green","type":"text"}]}} replace
...
setblock 30004 15 0 minecraft:oak_wall_sign[facing=west]{front_text:{messages:['',{translate:"unlock",click_event:{"action":"run_command",command:"/function gamemode:escape/purchase/shaft"}}',{translate:"shaft"},{text:"50 Energy",color:"green","type":"text"}]}} replace
