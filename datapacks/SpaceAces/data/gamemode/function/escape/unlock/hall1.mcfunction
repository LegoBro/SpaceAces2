...
setblock 29918 1 27 minecraft:oak_wall_sign[facing=south]{front_text:{messages:['',{translate:"unlock",click_event:{"action":"run_command",command:"/function gamemode:escape/purchase/greenery"}}',{translate:"greenery"},{text:"15 Energy",color:"green","type":"text"}]}} replace
setblock 29893 1 27 minecraft:oak_wall_sign[facing=south]{front_text:{messages:['',{translate:"unlock",click_event:{"action":"run_command",command:"/function gamemode:escape/purchase/greenery"}}',{translate:"greenery"},{text:"15 Energy",color:"green","type":"text"}]}} replace
...
setblock 29913 1 42 minecraft:oak_wall_sign[facing=west]{front_text:{messages:['',{translate:"unlock",click_event:{"action":"run_command",command:"/function gamemode:escape/purchase/stairs"}}',{translate:"stairs"},{text:"25 Energy",color:"green","type":"text"}]}} replace
