...
execute if block 29911 15 51 minecraft:barrier run setblock 29929 15 41 minecraft:oak_wall_sign[facing=north]{front_text:{messages:['""','{"translate":"unlock","clickEvent":{"action":"run_command","value":"/function gamemode:escape/purchase/mess_hall"}}','{"translate":"mess_hall"}','{"text":"30 Energy","color":"green","type":"text"}']}} replace
