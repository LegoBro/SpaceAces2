...
execute if score @s i matches 101.. run effect give @p[tag=escape,team=blue] minecraft:saturation 1 10
execute if score @s i matches 101.. run tellraw @a[tag=escape] {"translate":"terminal_deactivated"}
execute if score @s i matches 101.. run playsound minecraft:shutdown player @a
