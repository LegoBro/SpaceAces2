execute as @a[distance=..5,tag=in_game,team=blue] if score point Numbers matches -1.. run scoreboard players remove point Numbers 1
execute as @a[distance=..5,tag=in_game,team=red] if score point Numbers < setRate Numbers run scoreboard players add point Numbers 1
bossbar set minecraft:blue players
bossbar set minecraft:red players @a
execute unless entity @a[distance=..5,tag=in_game,team=blue] run scoreboard players operation redCapture Numbers += point Numbers
