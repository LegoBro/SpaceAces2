...
execute if score Map settings matches 0 run function arena:load_layered
execute if score Map settings matches 1 run function arena:load_frigate
execute if score Map settings matches 2 run function arena:load_arena
execute if score Map settings matches 3 run function arena:load_sewage
execute if score Map settings matches 4 run function arena:load_farm
