...
execute if score @s health matches ..0 run tag @s[tag=kill_effect_override] add kill_trigger
execute if score @s health matches ..0 run kill @s[tag=!kill_effect_override]
