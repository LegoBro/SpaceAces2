...
# Spawn new indicator
execute anchored eyes positioned ^ ^ ^ run summon minecraft:text_display ~ ~0.5 ~ {Tags:["heal_indicator","new","ignore.projectiles"],billboard:center,text:{"score":{"name":"#healing","objective":"healing"},color:"green","type":"score"},teleport_duration:1,brightness:{block:15,sky:15},background:0}
