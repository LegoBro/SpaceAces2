...
# Chunk for indicator
tag @s add indicator
summon minecraft:area_effect_cloud ~ ~1.5 ~ {CustomNameVisible:1b,Particle:{type:"minecraft:item_slime"},ReapplicationDelay:500,Radius:0.0f,RadiusPerTick:0.0f,RadiusOnUse:0.0f,Duration:50,DurationOnUse:0.0f,Age:0,WaitTime:0,Tags:["heal_indicator","new","ignore.projectiles"]}
