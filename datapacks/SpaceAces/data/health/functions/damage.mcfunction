...
execute positioned ~ ~1.6 ~ run particle block blue_stained_glass ^ ^ ^.3 0.1 0.1 0.1 0 1 force @s
...
#Run if you die
execute as @s[gamemode=adventure,scores={health=..0},tag=!entity,tag=!escape] at @s run function health:death
execute as @s[gamemode=adventure,team=blue,scores={health=..0},tag=!entity,tag=escape] at @s run function health:knocked_down
