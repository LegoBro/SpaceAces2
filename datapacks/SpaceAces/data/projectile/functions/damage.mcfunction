...
execute if entity @s[tag=blue] at @e[type=!item_frame,tag=!turret,tag=!ignore,limit=1,sort=nearest,tag=!raycast] run function projectile:hit_dict/blue_hit
execute if entity @s[tag=red] at @e[type=!item_frame,tag=!turret,tag=!ignore,limit=1,sort=nearest,tag=!raycast] run function projectile:hit_dict/red_hit
