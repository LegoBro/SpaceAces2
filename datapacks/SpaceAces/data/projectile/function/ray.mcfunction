...
execute if entity @s[tag=near_hb] positioned ~ ~-1 ~ if entity @e[distance=..2,tag=!raycast,tag=!ignore] unless score @s id = @e[distance=..2,tag=!raycast,sort=nearest,limit=1] id positioned ~ ~1 ~ run function projectile:hitbox
