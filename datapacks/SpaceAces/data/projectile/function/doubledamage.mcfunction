...
execute if entity @s[tag=blue] at @e[type=!minecraft:item_frame,tag=!turret,tag=!raycast,sort=nearest,limit=1] run function projectile:hit_dict/blue_hit
execute if entity @s[tag=red] at @e[type=!minecraft:item_frame,tag=!turret,tag=!raycast,sort=nearest,limit=1] run function projectile:hit_dict/red_hit
