...
execute as @e[type=marker,tag=red_spawn_point] at @s run summon item_frame ~ ~ ~ {Facing:1b,Item:{id:"minecraft:red_dye",count:1},Invulnerable:1b,Tags:["red_spawn"]}
execute as @e[type=marker,tag=general_spawn_point] at @s run summon item_frame ~ ~ ~ {Facing:1b,Item:{id:"minecraft:bone_meal",count:1},Invulnerable:1b,Tags:["general_spawn"]}
