...
execute as @e[type=marker,tag=weather.cloud_emitter.density_up] at @s run function weather:cloud_emitter/density_up
execute as @e[type=marker,tag=weather.cloud_emitter.density_down] at @s run function weather:cloud_emitter/density_down
