...
# 32
execute if score @s weather.size matches 3 run summon item_display ~ ~ ~-15.9 {Tags:["skybox","arena","arena.ruins","arena.cloud","weather.cloud","weather.spawn"],item:{id:"minecraft:green_stained_glass",count:1,components:{"minecraft:item_model":"arena/ruins/sky_poison"}},view_range:10f,shadow_radius:0f,shadow_strength:0f,billboard:"fixed",item_display:"ground",brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[32f,32f,32f]},teleport_duration:1}
