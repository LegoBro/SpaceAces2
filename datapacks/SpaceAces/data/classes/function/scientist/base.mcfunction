...
execute if entity @s[scores={ability.1.cooldown=400}] run function classes:scientist/healing_machine/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=200}] run function classes:scientist/healing_machine/deactivate
...
execute if entity @s[scores={ability.2.cooldown=300}] run function classes:scientist/medicine/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=200}] run function classes:scientist/medicine/deactivate
