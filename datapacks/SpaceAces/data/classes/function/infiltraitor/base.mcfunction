...
execute if entity @s[scores={ability.1.cooldown=200}] run function classes:infiltraitor/cloak/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=100}] run function classes:infiltraitor/cloak/deactivate
...
execute if entity @s[scores={ability.2.cooldown=300}] run function classes:infiltraitor/jammer/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=295}] run function classes:infiltraitor/jammer/deactivate
