...
execute if entity @s[team=blue] run scoreboard players add @a[distance=..4,team=red] activate_second 200
execute if entity @s[team=blue] run scoreboard players add @a[distance=..5,team=red] activate_third 200
...
execute if entity @s[team=red] run scoreboard players add @a[distance=..4,team=blue] activate_second 200
execute if entity @s[team=red] run scoreboard players add @a[distance=..5,team=blue] activate_third 200
