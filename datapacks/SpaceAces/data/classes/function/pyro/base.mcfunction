...
execute if entity @s[scores={ability.1.cooldown=300}] run function classes:pyro/fire_bomb/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=200}] run function classes:pyro/fire_bomb/deactivate
...
execute if entity @s[scores={ability.2.cooldown=240}] run function classes:pyro/immunity/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=140}] run function classes:pyro/immunity/deactivate
