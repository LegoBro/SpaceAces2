...
execute if entity @s[scores={ability.1.cooldown=600}] run function classes:mechanic/turret/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=500}] run function classes:mechanic/turret/deactivate
...
execute if entity @s[scores={ability.2.cooldown=20}] run function classes:mechanic/wrench/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=5}] run function classes:mechanic/wrench/deactivate
