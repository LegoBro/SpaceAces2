...
execute if entity @s[scores={ability.1.cooldown=100}] run function classes:4/mobility/warp/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=99}] run function classes:4/mobility/warp/deactivate
...
execute if entity @s[scores={ability.2.cooldown=160}] run function classes:4/mobility/flash_grenade/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=150}] run function classes:4/mobility/flash_grenade/deactivate
...
execute if score @s shoot matches 1 run function classes:4/mobility/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=3..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function classes:4/mobility/reload
