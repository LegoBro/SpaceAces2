...
execute if score @s shoot matches 3 run function classes:4/mobility/primary/shoot
execute if score @s shoot matches 4 run function classes:4/mobility/primary/shoot
