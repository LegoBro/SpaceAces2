...
execute as @e[type=minecraft:area_effect_cloud,tag=pistol,tag=new,sort=nearest,limit=1,distance=..3] at @s run function classes:4/mobility/primary/projectile
