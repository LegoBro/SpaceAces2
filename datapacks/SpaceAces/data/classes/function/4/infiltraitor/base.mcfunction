...
execute if entity @s[scores={ability.1.cooldown=200}] run function classes:4/infiltraitor/cloak/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=100}] run function classes:4/infiltraitor/cloak/deactivate
...
execute if entity @s[scores={ability.2.cooldown=300}] run function classes:4/infiltraitor/jammer/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=295}] run function classes:4/infiltraitor/jammer/deactivate
...
function classes:4/infiltraitor/recloak/run
...
execute if score @s shoot matches 1 run function classes:4/infiltraitor/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=15..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function classes:4/infiltraitor/reload
