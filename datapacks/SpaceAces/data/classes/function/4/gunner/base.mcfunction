...
execute if entity @s[scores={ability.1.cooldown=580..600}] run function classes:gunner/infinite_ammo/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=580}] run function classes:gunner/infinite_ammo/deactivate
...
execute if entity @s[scores={ability.2.cooldown=400}] run function classes:gunner/large_heal/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=380}] run function classes:gunner/large_heal/deactivate
