...
execute if score @s SelectedItem matches 1 if score @s ability.1.cooldown matches ..-10 unless entity @s[tag=input.right_click] run function classes:4/sniper/starpiercer/shoot
