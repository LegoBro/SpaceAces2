...
execute as @e[type=minecraft:area_effect_cloud,tag=sniper,tag=new,sort=nearest,limit=1,distance=..3] at @s run function classes:4/sniper/starpiercer/projectile
