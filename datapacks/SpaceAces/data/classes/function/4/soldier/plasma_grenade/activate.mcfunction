...
execute as @e[type=minecraft:item_display,tag=plasma_grenade,tag=new,sort=nearest,limit=1,distance=..3] at @s positioned ~ ~.25 ~ run function classes:4/bomber/primary/projectile
