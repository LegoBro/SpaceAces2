...
execute if entity @s[tag=blue] positioned ~ ~1.5 ~ as @e[distance=..2,team=red] run function classes:brawler/sword_throw/damage
execute if entity @s[tag=red] positioned ~ ~1.5 ~ as @e[distance=..2,team=blue] run function classes:brawler/sword_throw/damage
