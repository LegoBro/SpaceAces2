...
execute if entity @s[scores={activate_1=1..}] run item replace entity @s hotbar.1 with minecraft:gray_dye
scoreboard players remove @s[scores={activate_1=1..}] activate_1 1
execute if entity @s[scores={activate_1=195}] run function classes:3.4/scout/launch/deactivate
return 1