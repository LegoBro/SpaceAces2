...
execute if entity @s[scores={activate_second=60}] run function classes:3.4/scout/boost/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=40}] run function classes:3.4/scout/boost/deactivate
...
execute if entity @s[scores={activate_third=200}] run function classes:3.4/scout/launch/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=195}] run function classes:3.4/scout/launch/deactivate
