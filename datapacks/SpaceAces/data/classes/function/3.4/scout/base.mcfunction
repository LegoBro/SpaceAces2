...
execute if entity @s[scores={ability.1.cooldown=60}] run function classes:3.4/scout/boost/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=40}] run function classes:3.4/scout/boost/deactivate
...
execute if entity @s[scores={ability.2.cooldown=200}] run function classes:3.4/scout/launch/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=195}] run function classes:3.4/scout/launch/deactivate
...
function classes:3.4/scout/adrenaline/run
...
execute if score @s shoot matches 1 run function classes:3.4/scout/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=3..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function classes:3.4/scout/reload
