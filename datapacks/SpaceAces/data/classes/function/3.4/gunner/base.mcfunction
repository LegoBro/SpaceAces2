...
execute if entity @s[scores={ability.1.cooldown=580..600}] run function classes:3.4/gunner/infinite_ammo/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=580}] run function classes:3.4/gunner/infinite_ammo/deactivate
...
execute if entity @s[scores={ability.2.cooldown=400}] run function classes:3.4/gunner/large_heal/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=380}] run function classes:3.4/gunner/large_heal/deactivate
...
execute if score @s shoot matches 1 run function classes:3.4/gunner/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=1..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function classes:3.4/gunner/reload
