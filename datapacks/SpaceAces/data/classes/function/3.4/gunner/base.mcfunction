...
execute if entity @s[scores={activate_second=580..600}] run function classes:3.4/gunner/infinite_ammo/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=580}] run function classes:3.4/gunner/infinite_ammo/deactivate
...
execute if entity @s[scores={activate_third=400}] run function classes:3.4/gunner/large_heal/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=380}] run function classes:3.4/gunner/large_heal/deactivate
