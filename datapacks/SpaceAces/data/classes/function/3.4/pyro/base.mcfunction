...
execute if entity @s[scores={ability.1.cooldown=300}] run function classes:3.4/pyro/fire_bomb/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=200}] run function classes:3.4/pyro/fire_bomb/deactivate
...
execute if entity @s[scores={ability.2.cooldown=240}] run function classes:3.4/pyro/immunity/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=140}] run function classes:3.4/pyro/immunity/deactivate

# Passive
item replace entity @s hotbar.3 with minecraft:turtle_scute[minecraft:item_model="pyro/3",minecraft:custom_name='{"color":"white","translate":"turn_up"}',minecraft:lore=['{"color":"white","translate":"turn_up_lore1"}','{"color":"white","translate":"turn_up_lore2"}'],minecraft:unbreakable={show_in_tooltip:0b},minecraft:hide_additional_tooltip={}]
...
execute if score @s shoot matches 1 run function classes:3.4/pyro/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=3..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function classes:3.4/pyro/reload
