...
execute if entity @s[scores={activate_second=300}] run function classes:3.4/pyro/fire_bomb/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=200}] run function classes:3.4/pyro/fire_bomb/deactivate
...
execute if entity @s[scores={activate_third=240}] run function classes:3.4/pyro/immunity/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=140}] run function classes:3.4/pyro/immunity/deactivate
