...
execute as @e[type=minecraft:armor_stand,tag=fire_bomb,sort=nearest,limit=1,distance=..3] at @s positioned ~ ~1.25 ~ run function classes:3.4/pyro/fire_bomb/projectile
