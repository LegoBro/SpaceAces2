...
execute if entity @s[scores={activate_second=100}] run function classes:3.4/sniper/vis_mine/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=40}] run function classes:3.4/sniper/vis_mine/deactivate
...
execute if entity @s[scores={activate_third=200}] run function classes:3.4/sniper/jump/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=100}] run function classes:3.4/sniper/jump/deactivate
