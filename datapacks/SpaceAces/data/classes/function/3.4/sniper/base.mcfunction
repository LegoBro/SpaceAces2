...
execute if entity @s[scores={ability.1.cooldown=100}] run function classes:3.4/sniper/vis_mine/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=40}] run function classes:3.4/sniper/vis_mine/deactivate
...
execute if entity @s[scores={ability.2.cooldown=200}] run function classes:3.4/sniper/jump/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=100}] run function classes:3.4/sniper/jump/deactivate
...
function classes:3.4/sniper/distance/run
...
execute if score @s shoot matches 1 run function classes:3.4/sniper/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=15..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function classes:3.4/sniper/reload
