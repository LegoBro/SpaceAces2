...
execute if entity @s[scores={ability.1.cooldown=400}] run function classes:3.4/scientist/healing_machine/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=200}] run function classes:3.4/scientist/healing_machine/deactivate
...
execute if entity @s[scores={ability.2.cooldown=300}] run function classes:3.4/scientist/medicine/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=200}] run function classes:3.4/scientist/medicine/deactivate
...
execute if entity @s[scores={reload=39}] run function classes:3.4/scientist/biohazard/run
...
execute if score @s shoot matches 1 run function classes:3.4/scientist/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=3..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function classes:3.4/scientist/reload
