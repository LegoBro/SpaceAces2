...
execute if entity @s[scores={activate_second=400}] run function classes:3.4/scientist/healing_machine/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=200}] run function classes:3.4/scientist/healing_machine/deactivate
...
execute if entity @s[scores={activate_third=300}] run function classes:3.4/scientist/medicine/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=200}] run function classes:3.4/scientist/medicine/deactivate
