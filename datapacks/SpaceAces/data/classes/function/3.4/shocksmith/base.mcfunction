...
execute if entity @s[scores={activate_second=50}] run function classes:3.4/shocksmith/stun/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=45}] run function classes:3.4/shocksmith/stun/deactivate
...
execute if entity @s[scores={activate_third=300}] run function classes:3.4/shocksmith/energy_sap/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=100}] run function classes:3.4/shocksmith/energy_sap/deactivate
