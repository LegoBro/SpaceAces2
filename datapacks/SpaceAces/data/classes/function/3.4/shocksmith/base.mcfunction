...
execute if entity @s[scores={ability.1.cooldown=50}] run function classes:3.4/shocksmith/stun/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=45}] run function classes:3.4/shocksmith/stun/deactivate
...
execute if entity @s[scores={ability.2.cooldown=300}] run function classes:3.4/shocksmith/energy_sap/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=100}] run function classes:3.4/shocksmith/energy_sap/deactivate
...
execute if entity @s[scores={energy=20..}] run function classes:3.4/shocksmith/energy_dispersion/run
...
execute if score @s shoot matches 1 run function classes:3.4/shocksmith/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=7..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function classes:3.4/shocksmith/reload
