...
execute if entity @s[scores={activate_second=100}] run function classes:3.4/brawler/sword_throw/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=95}] run function classes:3.4/brawler/sword_throw/deactivate
...
execute if entity @s[scores={activate_third=389..400}] run function classes:3.4/brawler/spin_slash/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=389}] run function classes:3.4/brawler/spin_slash/deactivate
