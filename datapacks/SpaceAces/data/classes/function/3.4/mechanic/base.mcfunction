...
execute if entity @s[scores={activate_second=600}] run function classes:3.4/mechanic/turret/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=500}] run function classes:3.4/mechanic/turret/deactivate
...
execute if entity @s[scores={activate_third=20}] run function classes:3.4/mechanic/wrench/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=5}] run function classes:3.4/mechanic/wrench/deactivate
