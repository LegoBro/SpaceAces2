...
execute if entity @s[scores={health=100..}] as @e[type=minecraft:armor_stand,tag=turret,sort=nearest,limit=1,distance=..3] run function classes:3.4/mechanic/wrench/change
