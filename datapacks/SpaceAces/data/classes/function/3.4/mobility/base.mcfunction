...
execute if entity @s[scores={activate_second=100}] run function classes:3.4/mobility/warp/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=99}] run function classes:3.4/mobility/warp/deactivate
...
execute if entity @s[scores={activate_third=160}] run function classes:3.4/mobility/flash_grenade/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=150}] run function classes:3.4/mobility/flash_grenade/deactivate
