...
execute if entity @s[scores={crouching=0}] run tp @e[type=minecraft:armor_stand,tag=flash_grenade,sort=nearest,limit=1,distance=..3] ~ ~.6 ~ ~ ~
execute if entity @s[scores={crouching=1}] run tp @e[type=minecraft:armor_stand,tag=flash_grenade,sort=nearest,limit=1,distance=..3] ~ ~.26 ~ ~ ~
...
execute as @e[type=minecraft:armor_stand,tag=flash_grenade,sort=nearest,limit=1,distance=..3] at @s positioned ~ ~1.25 ~ run function classes:3.4/mobility/flash_grenade/projectile
