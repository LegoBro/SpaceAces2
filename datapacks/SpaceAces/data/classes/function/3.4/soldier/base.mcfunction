...
execute if entity @s[scores={ability.1.cooldown=100}] run function classes:3.4/soldier/plasma_grenade/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=98}] run function classes:3.4/soldier/plasma_grenade/deactivate
...
execute if entity @s[scores={ability.2.cooldown=180..200}] run function classes:3.4/soldier/burst_heal/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=180}] run function classes:3.4/soldier/burst_heal/deactivate
...
execute if entity @s[scores={totalShots=15..}] run function classes:3.4/soldier/prepared/run
...
execute if score @s shoot matches 1 run function classes:3.4/soldier/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=3..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function classes:3.4/soldier/reload
