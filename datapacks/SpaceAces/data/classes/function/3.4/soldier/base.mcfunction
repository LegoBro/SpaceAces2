...
execute if entity @s[scores={activate_second=100}] run function classes:3.4/soldier/plasma_grenade/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=98}] run function classes:3.4/soldier/plasma_grenade/deactivate
...
execute if entity @s[scores={activate_third=180..200}] run function classes:3.4/soldier/burst_heal/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=180}] run function classes:3.4/soldier/burst_heal/deactivate
