...
execute if entity @s[scores={ability.1.cooldown=100}] run function classes:3.4/rocketeer/piercing_dart/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=90}] run function classes:3.4/rocketeer/piercing_dart/deactivate
...
execute if entity @s[scores={ability.2.cooldown=400}] run function classes:3.4/rocketeer/resist/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=340}] run function classes:3.4/rocketeer/resist/deactivate
...
function classes:3.4/rocketeer/rocket_boots/run
...
execute if score @s shoot matches 1 run function classes:3.4/rocketeer/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=16..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function classes:3.4/rocketeer/reload
