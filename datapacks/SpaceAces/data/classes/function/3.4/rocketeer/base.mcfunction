...
execute if entity @s[scores={activate_second=100}] run function classes:3.4/rocketeer/piercing_dart/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=90}] run function classes:3.4/rocketeer/piercing_dart/deactivate
...
execute if entity @s[scores={activate_third=400}] run function classes:3.4/rocketeer/resist/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=340}] run function classes:3.4/rocketeer/resist/deactivate
