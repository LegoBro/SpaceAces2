...
execute as @e[type=minecraft:area_effect_cloud,tag=dart,sort=nearest,limit=1,distance=..3] at @s run function classes:3.4/rocketeer/piercing_dart/projectile
