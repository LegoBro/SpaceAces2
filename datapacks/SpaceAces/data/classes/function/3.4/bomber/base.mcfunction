...
execute if entity @s[scores={ability.1.cooldown=60}] run function classes:3.4/bomber/sticky_bomb/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=55}] run function classes:3.4/bomber/sticky_bomb/deactivate
...
execute if entity @s[scores={ability.2.cooldown=60}] run function classes:3.4/bomber/detonator/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=40}] run function classes:3.4/bomber/detonator/deactivate
