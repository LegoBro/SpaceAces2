...
execute if entity @s[scores={activate_second=60}] run function classes:3.4/bomber/sticky_bomb/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=55}] run function classes:3.4/bomber/sticky_bomb/deactivate
...
execute if entity @s[scores={activate_third=60}] run function classes:3.4/bomber/detonator/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=40}] run function classes:3.4/bomber/detonator/deactivate
...
execute if entity @s[scores={health=..0}] unless entity @s[tag=escape,team=red] run function classes:3.4/bomber/death_impact
...
execute if score @s shoot matches 1 run function classes:3.4/bomber/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=25..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function classes:3.4/bomber/reload
