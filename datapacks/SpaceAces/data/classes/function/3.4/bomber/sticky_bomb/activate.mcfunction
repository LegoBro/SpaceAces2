...
execute as @e[type=minecraft:armor_stand,tag=sticky_bomb,sort=nearest,limit=1,distance=..1] at @s positioned ~ ~1.25 ~ run function classes:3.4/bomber/sticky_bomb/projectile
