...
execute if entity @s[scores={ability.1.cooldown=60}] run function classes:3.4/seeker/poison_jab/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=50}] run function classes:3.4/seeker/poison_jab/deactivate
...
execute if entity @s[scores={ability.2.cooldown=300}] run function classes:3.4/seeker/slow_field/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=240}] run function classes:3.4/seeker/slow_field/deactivate
...
function classes:3.4/seeker/weak_glow/run
...
execute if score @s shoot matches 1 run function classes:3.4/seeker/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=5..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function classes:3.4/seeker/reload
