...
execute if entity @s[scores={activate_second=60}] run function classes:3.4/seeker/poison_jab/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=50}] run function classes:3.4/seeker/poison_jab/deactivate
...
execute if entity @s[scores={activate_third=300}] run function classes:3.4/seeker/slow_field/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=240}] run function classes:3.4/seeker/slow_field/deactivate
