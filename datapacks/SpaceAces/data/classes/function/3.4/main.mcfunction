...
#scoreboard players set @s damageMultiplier 0
...
# Special Effects
execute if entity @s[scores={invis=1..}] run function classes:4/infiltraitor/cloak/timer
execute if entity @s[scores={over_heal=1..}] run function classes:4/healer/over_heal_machine/timer
execute if entity @s[scores={resist=1..}] run function classes:4/rocketeer/resist/timer
execute if entity @s[scores={invulnerable=1..}] run function classes:4/brawler/spin_slash/timer
