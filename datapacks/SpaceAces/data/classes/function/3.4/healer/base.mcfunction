...
execute if entity @s[scores={activate_second=300}] run function classes:3.4/healer/angry_medic/activate
scoreboard players remove @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=200}] run function classes:3.4/healer/angry_medic/deactivate
...
execute if entity @s[scores={activate_third=400}] run function classes:3.4/healer/over_heal_machine/activate
scoreboard players remove @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=200}] run function classes:3.4/healer/over_heal_machine/deactivate
