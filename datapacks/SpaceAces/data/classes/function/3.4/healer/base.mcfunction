...
execute if entity @s[scores={ability.1.cooldown=300}] run function classes:3.4/healer/angry_medic/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=200}] run function classes:3.4/healer/angry_medic/deactivate
...
execute if entity @s[scores={ability.2.cooldown=400}] run function classes:3.4/healer/over_heal_machine/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=200}] run function classes:3.4/healer/over_heal_machine/deactivate
...
execute if entity @s[scores={last_shot=1..}] run function classes:3.4/healer/days_work/run
...
execute if score @s shoot matches 1 run function classes:3.4/healer/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=4..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function classes:3.4/healer/reload
