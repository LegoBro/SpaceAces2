...
execute as @e[type=minecraft:area_effect_cloud,tag=shock_grenade_shot,sort=nearest,limit=1,distance=..3] at @s run function classes:shocksmith/grenade/projectile
