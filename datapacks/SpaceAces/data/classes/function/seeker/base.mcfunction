...
execute if entity @s[scores={ability.1.cooldown=60}] run function classes:seeker/poison_jab/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=50}] run function classes:seeker/poison_jab/deactivate
...
execute if entity @s[scores={ability.2.cooldown=300}] run function classes:seeker/slow_field/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=240}] run function classes:seeker/slow_field/deactivate
