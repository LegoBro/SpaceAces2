...
execute if score @s totalShots >= class.sniper.primary.ammo Numbers run scoreboard players set @s reload 0
...
# Reload Done
execute if score @s reload >= class.sniper.primary.reload Numbers run function classes:sniper/primary/reload
