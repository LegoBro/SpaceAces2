...
execute if entity @s[scores={ability.1.cooldown=100}] run function classes:sniper/vis_mine/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=40}] run function classes:sniper/vis_mine/deactivate
...
execute if entity @s[scores={ability.2.cooldown=200}] run function classes:sniper/jump/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=100}] run function classes:sniper/jump/deactivate
