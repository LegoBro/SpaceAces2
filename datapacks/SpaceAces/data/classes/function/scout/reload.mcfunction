...
scoreboard players set class.scout.health Numbers 100
scoreboard players set class.scout.speed Numbers 140
...
scoreboard players set class.scout.primary.ammo Numbers 8
scoreboard players set class.scout.1.cooldown Numbers 60
scoreboard players set class.scout.1.duration Numbers 20