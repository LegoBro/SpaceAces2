...
execute if score @s reload matches 1.. run function classes:scout/primary/reloading
execute if score @s shoot matches 1.. run function classes:scout/primary/use


# 1st Ability: Dodge
execute if score @s ability.1.cooldown matches ..0 run function classes:scout/boost/ready
execute if score @s ability.1.cooldown matches 1.. run function classes:scout/boost/cooldown
...
execute if entity @s[tag=scout.double_jump.clear] run function classes:scout/double_jump/deactivate
execute if entity @s[tag=input.jump.start,tag=scout.double_jump.await] unless predicate input:on_ground run function classes:scout/double_jump/activate
...
execute if predicate input:on_ground run function classes:scout/double_jump/reset
