...
execute if entity @s[scores={ability.1.cooldown=100}] run function classes:soldier/plasma_grenade/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=98}] run function classes:soldier/plasma_grenade/deactivate
...
execute if entity @s[scores={ability.2.cooldown=180..200}] run function classes:soldier/burst_heal/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=180}] run function classes:soldier/burst_heal/deactivate
