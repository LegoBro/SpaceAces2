...
execute as @e[type=minecraft:item_display,tag=plasma_grenade,sort=nearest,limit=1,distance=..3] at @s positioned ~ ~1.25 ~ run function classes:bomber/projectile
