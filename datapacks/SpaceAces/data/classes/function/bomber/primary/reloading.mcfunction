...
execute if score @s totalShots >= class.bomber.primary.ammo Numbers run scoreboard players set @s reload 0
...
# Reload Done
execute if score @s[tag=!class.bomber.sticky_mode] reload >= class.bomber.primary.reload Numbers run function classes:bomber/primary/reload
execute if score @s[tag=class.bomber.sticky_mode] reload >= class.bomber.primary.reload Numbers run function classes:bomber/sticky_bomb/reload
