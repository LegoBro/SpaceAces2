...
execute if entity @s[scores={ability.1.cooldown=100}] run function classes:mobility/warp/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=99}] run function classes:mobility/warp/deactivate
...
execute if entity @s[scores={ability.2.cooldown=160}] run function classes:mobility/flash_grenade/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=150}] run function classes:mobility/flash_grenade/deactivate
