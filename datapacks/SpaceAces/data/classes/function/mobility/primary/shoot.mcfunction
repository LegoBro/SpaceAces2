...
scoreboard players operation @n[type=minecraft:area_effect_cloud,tag=pistol,sort=nearest,limit=1,distance=..3] Team = @s Team
...
execute anchored eyes run tp @e[type=minecraft:area_effect_cloud,tag=pistol,sort=nearest,limit=1,distance=..3] ^ ^ ^ ~ ~
execute store result score @e[type=minecraft:area_effect_cloud,tag=pistol,sort=nearest,limit=1,distance=..3] id run scoreboard players get @s id
execute as @e[type=minecraft:area_effect_cloud,tag=pistol,sort=nearest,limit=1,distance=..3] at @s run function classes:mobility/primary/projectile
