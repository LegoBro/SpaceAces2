...
execute if score @s totalShots >= class.mobility.primary.ammo Numbers run scoreboard players set @s reload 0
...
# Reload Done
execute if score @s reload >= class.mobility.primary.reload Numbers run function classes:mobility/primary/reload
