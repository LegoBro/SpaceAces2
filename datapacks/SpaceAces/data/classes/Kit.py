...
# Passive
#replaceitem entity @s hotbar.3 turtle_scute{display:{Name:"${Translate(c.passive.name,"white")}",Lore:["${passiveLore}"]},HideFlags:63,CustomModelData:${11000003+(10000*c.id)},Unbreakable:1}
#${c.passive.command}
