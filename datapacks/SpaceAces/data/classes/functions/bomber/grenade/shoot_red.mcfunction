...
summon area_effect_cloud ~ ~ ~ {Particle:"dolphin",ReapplicationDelay:0,Radius:0f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:600,DurationOnUse:0f,Age:0,Tags:["grenade_shot","raycast","red"]}
...
execute if entity @s[scores={crouching=0}] run tp @e[tag=grenade_shot,limit=1,sort=nearest] ~ ~ ~ ~ ~
