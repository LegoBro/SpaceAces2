## Blue
effect give @a[team=blue,distance=..3] hunger 5 5
effect give @a[team=red,distance=..3] saturation 1 0

##
summon area_effect_cloud ~ ~ ~ {Particle:"dolphin",ReapplicationDelay:0,Radius:0f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:600,DurationOnUse:0f,Age:0,Tags:["shock_grenade_shot","raycast","red"]}
