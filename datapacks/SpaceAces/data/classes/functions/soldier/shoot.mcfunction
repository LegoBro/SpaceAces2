...
execute if entity @s[scores={crouching=0}] run tp @e[tag=rifle,limit=1,sort=nearest] ~ ~1.6 ~ ~ ~
execute if entity @s[scores={crouching=1..}] run tp @e[tag=rifle,limit=1,sort=nearest] ~ ~1.26 ~ ~ ~
