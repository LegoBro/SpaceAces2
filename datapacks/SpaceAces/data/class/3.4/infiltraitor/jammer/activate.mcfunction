...
execute if entity @s[team=blue] at @a[distance=..5,team=red] run particle minecraft:block{block_state:{id:"minecraft:red_terracotta"}} ~ ~ ~ 0.3 1.3 .3 .5 15 force @a
execute if entity @s[team=blue] at @a[distance=..4,team=red] run particle minecraft:block{block_state:{id:"minecraft:red_terracotta"}} ~ ~ ~ 0.3 1.3 .3 .5 15 force @a
execute if entity @s[team=blue] at @a[distance=..3,team=red] run particle minecraft:block{block_state:{id:"minecraft:red_terracotta"}} ~ ~ ~ 0.3 1.3 .3 .5 15 force @a
...
execute if entity @s[team=red] at @a[distance=..5,team=blue] run particle minecraft:block{block_state:{id:"minecraft:red_terracotta"}} ~ ~ ~ 0.3 1.3 .3 .5 15 force @a
execute if entity @s[team=red] at @a[distance=..4,team=blue] run particle minecraft:block{block_state:{id:"minecraft:red_terracotta"}} ~ ~ ~ 0.3 1.3 .3 .5 15 force @a
execute if entity @s[team=red] at @a[distance=..3,team=blue] run particle minecraft:block{block_state:{id:"minecraft:red_terracotta"}} ~ ~ ~ 0.3 1.3 .3 .5 15 force @a
