...
execute if entity @s[scores={ability.1.cooldown=100}] run function class:3.4/sniper/vis_mine/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=40}] run function class:3.4/sniper/vis_mine/deactivate

execute if entity @s[scores={ability.2.cooldown=0}] run item replace entity @s hotbar.2 with minecraft:carrot_on_a_stick[minecraft:item_model="sniper/2",minecraft:custom_name={color:"white",translate:"jump"},minecraft:lore=[{color:"white",translate:"jump_lore1"},{color:"white",translate:"jump_lore2"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
...
execute if entity @s[scores={ability.2.cooldown=200}] run function class:3.4/sniper/jump/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=100}] run function class:3.4/sniper/jump/deactivate

# Passive
item replace entity @s hotbar.3 with minecraft:turtle_scute[minecraft:item_model="sniper/3",minecraft:custom_name={color:"white",translate:"distance"},minecraft:lore=[{color:"white",translate:"distance_lore1"},{color:"white",translate:"distance_lore2"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
function class:3.4/sniper/distance/run

scoreboard players set @s maxHealth 150

item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:item_model="sniper/0",minecraft:custom_name={translate:"star_sniper"},minecraft:lore=[{color:"white",translate:"star_sniper_lore"},{color:"white","italic":false,"text":" - damage: 50"},{color:"white","italic":false,"text":" - ammo: 6"},{color:"white","italic":false,"text":" - reload with speed: 3s"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
item replace entity @s[scores={reload=0,shoot=1..}] hotbar.0 with minecraft:paper[minecraft:item_model="sniper/0",minecraft:custom_name={translate:"star_sniper"},minecraft:lore=[{color:"white",translate:"star_sniper_lore"},{color:"white","italic":false,"text":" - damage: 50"},{color:"white","italic":false,"text":" - ammo: 6"},{color:"white","italic":false,"text":" - reload with speed: 3s"}],tooltip_display={hidden_components:["unbreakable"]}]
...
execute if score @s shoot matches 1 run function class:3.4/sniper/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=15..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function class:3.4/sniper/reload
