...
execute as @e[type=minecraft:armor_stand,tag=flash_grenade,sort=nearest,limit=1,distance=..3] at @s positioned ~ ~1.25 ~ run function class:3.4/mobility/flash_grenade/projectile
