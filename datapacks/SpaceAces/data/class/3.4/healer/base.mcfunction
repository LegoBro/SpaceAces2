...
execute if entity @s[scores={ability.1.cooldown=0}] run item replace entity @s hotbar.1 with minecraft:carrot_on_a_stick[minecraft:item_model="healer/1",minecraft:custom_name={color:"white",translate:"angry_medic"},minecraft:lore=[{color:"white",translate:"angry_medic_lore1"},{color:"white",translate:"angry_medic_lore2"},{color:"white",translate:"angry_medic_lore3"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
...
execute if entity @s[scores={ability.1.cooldown=300}] run function class:3.4/healer/angry_medic/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=200}] run function class:3.4/healer/angry_medic/deactivate

execute if entity @s[scores={ability.2.cooldown=0}] run item replace entity @s hotbar.2 with minecraft:carrot_on_a_stick[minecraft:item_model="healer/2",minecraft:custom_name={color:"white",translate:"over_heal_machine"},minecraft:lore=[{color:"white",translate:"over_heal_machine_lore1"},{color:"white",translate:"over_heal_machine_lore2"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
...
execute if entity @s[scores={ability.2.cooldown=400}] run function class:3.4/healer/over_heal_machine/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=200}] run function class:3.4/healer/over_heal_machine/deactivate

# Passive
item replace entity @s hotbar.3 with minecraft:turtle_scute[minecraft:item_model="healer/3",minecraft:custom_name={color:"white",translate:"days_work"},minecraft:lore=[{color:"white",translate:"days_work_lore1"},{color:"white",translate:"days_work_lore2"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
execute if entity @s[scores={last_shot=1..}] run function class:3.4/healer/days_work/run

scoreboard players set @s maxHealth 150

item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:item_model="healer/0",minecraft:custom_name={translate:"heal_pistol"},minecraft:lore=[{color:"white",translate:"heal_pistol_lore"},{color:"white","italic":false,"text":" - damage: 7"},{color:"white","italic":false,"text":" - ammo: 12"},{color:"white","italic":false,"text":" - reload with speed: 1.25s"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
item replace entity @s[scores={reload=0,shoot=1..}] hotbar.0 with minecraft:paper[minecraft:item_model="healer/0",minecraft:custom_name={translate:"heal_pistol"},minecraft:lore=[{color:"white",translate:"heal_pistol_lore"},{color:"white","italic":false,"text":" - damage: 7"},{color:"white","italic":false,"text":" - ammo: 12"},{color:"white","italic":false,"text":" - reload with speed: 1.25s"}],tooltip_display={hidden_components:["unbreakable"]}]
...
execute if score @s shoot matches 1 run function class:3.4/healer/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=4..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function class:3.4/healer/reload
