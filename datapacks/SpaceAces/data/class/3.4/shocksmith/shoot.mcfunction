...
execute as @e[type=minecraft:item_display,tag=shock_grenade,sort=nearest,limit=1,distance=..3] at @s positioned ~ ~.25 ~ run function class:3.4/shocksmith/projectile
