item replace entity @s[gamemode=!spectator,tag=!invis,scores={crouching=0}] armor.head with minecraft:leather_helmet[minecraft:attribute_modifiers={modifiers:[{type:"minecraft:movement_speed",id:"minecraft:d03be21c-51f4-4994-a5f7-56260febbd16",operation:"add_multiplied_total",amount:0.05d}]},minecraft:dyed_color={rgb:2593195},minecraft:enchantments={levels:{"minecraft:binding_curse":1},show_in_tooltip:0b},minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
item replace entity @s[tag=!invis,scores={crouching=1..}] armor.head with minecraft:leather_helmet[minecraft:attribute_modifiers={modifiers:[{type:"minecraft:movement_speed",id:"minecraft:d03be21c-51f4-4994-a5f7-56260febbd16",operation:"add_multiplied_total",amount:-0.1d}]},minecraft:dyed_color={rgb:2593195},minecraft:enchantments={levels:{"minecraft:binding_curse":1},show_in_tooltip:0b},minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]

execute if entity @s[scores={ability.1.cooldown=0}] run item replace entity @s hotbar.1 with minecraft:carrot_on_a_stick[item_model="bomber/1",minecraft:custom_name={color:"white",translate:"sticky_bomb"},minecraft:lore=[{color:"white",translate:"sticky_bomb_lore1"},{color:"white",translate:"sticky_bomb_lore2"},{color:"white",translate:"sticky_bomb_lore3"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
...
execute if entity @s[scores={ability.2.cooldown=40}] run function class:3.4/bomber/detonator/deactivate

# Passive
item replace entity @s hotbar.3 with minecraft:turtle_scute[item_model="bomber/3",minecraft:custom_name={color:"white",translate:"bomb_voyage"},minecraft:lore=[{color:"white",translate:"bomb_voyage_lore1"},{color:"white",translate:"bomb_voyage_lore2"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
execute if entity @s[scores={health=..0}] unless entity @s[tag=escape,team=red] run function class:3.4/bomber/death_impact

scoreboard players set @s maxHealth 150

item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[item_model="bomber/0",minecraft:custom_name={translate:"plasma_grenade_launcher"},minecraft:lore=[{color:"white",translate:"plasma_grenade_launcher_lore"},{color:"white","italic":false,"text":" - damage: 10"},{color:"white","italic":false,"text":" - ammo: 8"},{color:"white","italic":false,"text":" - reload with speed: 2.5s"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
item replace entity @s[scores={reload=0,shoot=1..}] hotbar.0 with minecraft:paper[item_model="bomber/0",minecraft:custom_name={translate:"plasma_grenade_launcher"},minecraft:lore=[{color:"white",translate:"plasma_grenade_launcher_lore"},{color:"white","italic":false,"text":" - damage: 10"},{color:"white","italic":false,"text":" - ammo: 8"},{color:"white","italic":false,"text":" - reload with speed: 2.5s"}],tooltip_display={hidden_components:["unbreakable"]}]
...
execute if score @s shoot matches 1 run function class:3.4/bomber/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=25..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function class:3.4/bomber/reload
