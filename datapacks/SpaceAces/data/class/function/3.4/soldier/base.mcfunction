...
execute if entity @s[scores={ability.2.cooldown=180..200}] run function class:3.4/soldier/burst_heal/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=180}] run function class:3.4/soldier/burst_heal/deactivate

# Passive
item replace entity @s hotbar.3 with minecraft:turtle_scute[minecraft:item_model="soldier/3",minecraft:custom_name={color:"white",translate:"prepared"},minecraft:lore=[{color:"white",translate:"prepared_lore1"},{color:"white",translate:"prepared_lore2"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
execute if entity @s[scores={totalShots=15..}] run function class:3.4/soldier/prepared/run

scoreboard players set @s maxHealth 150

item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:item_model="soldier/0",minecraft:custom_name={translate:"surge_rifle"},minecraft:lore=[{color:"white",translate:"surge_rifle_lore"},{color:"white","italic":false,"text":" - damage: 12"},{color:"white","italic":false,"text":" - ammo: 20"},{color:"white","italic":false,"text":" - reload with speed: 2.5s"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
item replace entity @s[scores={reload=0,shoot=1..}] hotbar.0 with minecraft:paper[minecraft:item_model="soldier/0",minecraft:custom_name={translate:"surge_rifle"},minecraft:lore=[{color:"white",translate:"surge_rifle_lore"},{color:"white","italic":false,"text":" - damage: 12"},{color:"white","italic":false,"text":" - ammo: 20"},{color:"white","italic":false,"text":" - reload with speed: 2.5s"}],tooltip_display={hidden_components:["unbreakable"]}]
...
execute if score @s shoot matches 1 run function class:3.4/soldier/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=3..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function class:3.4/soldier/reload
