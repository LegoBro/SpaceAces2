...
item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:item_model="shocksmith/0",minecraft:custom_name={translate:"shock_hopper"},minecraft:lore=[{color:"white",translate:"shock_hopper_lore"},{color:"white","italic":false,"text":" - damage: 15"},{color:"white","italic":false,"text":" - ammo: 6"},{color:"white","italic":false,"text":" - reload with speed: 2.5s"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
