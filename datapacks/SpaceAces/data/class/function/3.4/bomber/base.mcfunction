item replace entity @s[gamemode=!spectator,tag=!invis,scores={crouching=0}] armor.head with minecraft:leather_helmet[minecraft:attribute_modifiers={modifiers:[{type:"minecraft:movement_speed",id:"minecraft:d03be21c-51f4-4994-a5f7-56260febbd16",operation:"add_multiplied_total",amount:0.05d}]},minecraft:dyed_color={rgb:2593195},minecraft:enchantments={levels:{"minecraft:binding_curse":1},show_in_tooltip:0b},minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
...
item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[item_model="bomber/0",minecraft:custom_name={translate:"plasma_grenade_launcher"},minecraft:lore=[{color:"white",translate:"plasma_grenade_launcher_lore"},{color:"white","italic":false,"text":" - damage: 10"},{color:"white","italic":false,"text":" - ammo: 8"},{color:"white","italic":false,"text":" - reload with speed: 2.5s"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
