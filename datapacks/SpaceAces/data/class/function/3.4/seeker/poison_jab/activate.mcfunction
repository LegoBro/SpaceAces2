...
execute as @e[type=minecraft:armor_stand,tag=poison_jab,sort=nearest,limit=1,distance=..3] at @s positioned ~ ~1 ~ run function class:3.4/seeker/poison_jab/projectile
