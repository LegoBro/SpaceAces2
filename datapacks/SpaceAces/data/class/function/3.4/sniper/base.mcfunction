...
# Passive
item replace entity @s hotbar.3 with minecraft:turtle_scute[minecraft:item_model="sniper/3",minecraft:custom_name={color:"white",translate:"distance"},minecraft:lore=[{color:"white",translate:"distance_lore1"},{color:"white",translate:"distance_lore2"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
function class:3.4/sniper/distance/run

scoreboard players set @s maxHealth 150

item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:item_model="sniper/0",minecraft:custom_name={translate:"star_sniper"},minecraft:lore=[{color:"white",translate:"star_sniper_lore"},{color:"white","italic":false,"text":" - damage: 50"},{color:"white","italic":false,"text":" - ammo: 6"},{color:"white","italic":false,"text":" - reload with speed: 3s"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
