...
execute as @e[type=minecraft:item_display,tag=vis_mine,sort=nearest,limit=1,distance=..3] at @s positioned ~ ~.25 ~ run function class:3.4/sniper/vis_mine/projectile
