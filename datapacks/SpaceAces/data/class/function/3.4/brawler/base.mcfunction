...
execute if entity @s[scores={ability.1.cooldown=100}] run function class:3.4/brawler/sword_throw/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=95}] run function class:3.4/brawler/sword_throw/deactivate
...
execute if entity @s[scores={ability.2.cooldown=389..400}] run function class:3.4/brawler/spin_slash/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=389}] run function class:3.4/brawler/spin_slash/deactivate
...
function class:3.4/brawler/position/run
...
execute if score @s shoot matches 1 run function class:3.4/brawler/test_swipe
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=10..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function class:3.4/brawler/reload
