item replace entity @s[gamemode=!spectator,tag=!invis,scores={crouching=0}] armor.head with minecraft:leather_helmet[minecraft:attribute_modifiers={modifiers:[{type:"minecraft:movement_speed",id:"minecraft:d03be21c-51f4-4994-a5f7-56260febbd16",operation:"add_multiplied_total",amount:0.3d}]},minecraft:dyed_color={rgb:16777215},minecraft:enchantments={levels:{"minecraft:binding_curse":1},show_in_tooltip:0b},minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
item replace entity @s[tag=!invis,scores={crouching=1..}] armor.head with minecraft:leather_helmet[minecraft:attribute_modifiers={modifiers:[{type:"minecraft:movement_speed",id:"minecraft:d03be21c-51f4-4994-a5f7-56260febbd16",operation:"add_multiplied_total",amount:0.15d}]},minecraft:dyed_color={rgb:16777215},minecraft:enchantments={levels:{"minecraft:binding_curse":1},show_in_tooltip:0b},minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]

execute if entity @s[scores={ability.1.cooldown=0}] run item replace entity @s hotbar.1 with minecraft:carrot_on_a_stick[minecraft:item_model="infiltraitor/1",minecraft:custom_name={color:"white",translate:"cloak"},minecraft:lore=[{color:"white",translate:"cloak_lore1"},{color:"white",translate:"cloak_lore2"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
...
execute if entity @s[scores={ability.1.cooldown=200}] run function class:3.4/infiltraitor/cloak/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=100}] run function class:3.4/infiltraitor/cloak/deactivate

execute if entity @s[scores={ability.2.cooldown=0}] run item replace entity @s hotbar.2 with minecraft:carrot_on_a_stick[minecraft:item_model="infiltraitor/2",minecraft:custom_name={color:"white",translate:"jammer"},minecraft:lore=[{color:"white",translate:"jammer_lore1"},{color:"white",translate:"jammer_lore2"},{color:"white",translate:"jammer_lore3"},{color:"white",translate:"jammer_lore4"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
...
execute if entity @s[scores={ability.2.cooldown=300}] run function class:3.4/infiltraitor/jammer/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=295}] run function class:3.4/infiltraitor/jammer/deactivate
...
function class:3.4/infiltraitor/recloak/run

scoreboard players set @s maxHealth 100

item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:item_model="infiltraitor/0",minecraft:custom_name={translate:"plasma_pistol"},minecraft:lore=[{color:"white",translate:"plasma_pistol_lore"},{color:"white","italic":false,"text":" - damage: 50"},{color:"white","italic":false,"text":" - ammo: 6"},{color:"white","italic":false,"text":" - reload with speed: 1.75s"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
...
execute if score @s shoot matches 1 run function class:3.4/infiltraitor/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=15..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function class:3.4/infiltraitor/reload
