...
# Passive
item replace entity @s hotbar.3 with minecraft:turtle_scute[minecraft:item_model="gunner/3",minecraft:custom_name={color:"white",translate:"top"},minecraft:lore=[{color:"white",translate:"top_lore1"},{color:"white",translate:"top_lore2"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
execute if entity @s[scores={health=350}] run effect give @s minecraft:luck 1 25 true

scoreboard players set @s maxHealth 350

item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:item_model="gunner/0",minecraft:custom_name={translate:"plasma_cannon"},minecraft:lore=[{color:"white",translate:"plasma_cannon_lore"},{color:"white","italic":false,"text":" - damage: 8"},{color:"white","italic":false,"text":" - ammo: 30"},{color:"white","italic":false,"text":" - reload with speed: 3.5s"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
item replace entity @s[scores={reload=0,shoot=1..}] hotbar.0 with minecraft:paper[minecraft:item_model="gunner/0",minecraft:custom_name={translate:"plasma_cannon"},minecraft:lore=[{color:"white",translate:"plasma_cannon_lore"},{color:"white","italic":false,"text":" - damage: 8"},{color:"white","italic":false,"text":" - ammo: 30"},{color:"white","italic":false,"text":" - reload with speed: 3.5s"}],tooltip_display={hidden_components:["unbreakable"]}]
