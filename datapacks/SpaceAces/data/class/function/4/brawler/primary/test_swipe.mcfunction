...
execute anchored eyes positioned ^ ^ ^1 as @e[distance=..3,tag=hb] unless score @s Team = #Team Team run tag @s add class.brawler.target
execute anchored eyes positioned ^ ^ ^1 facing entity @e[distance=..3,tag=hb] feet run function class:4/brawler/primary/swipe
