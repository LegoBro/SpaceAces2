## dodge is ready
item replace entity @s hotbar.1 with minecraft:carrot_on_a_stick[minecraft:item_model="class/scout/dodge",minecraft:item_name={color:"white",translate:"class.scout.dodge"},minecraft:lore=[{color:"white","italic":false,translate:"class.scout.dodge.lore.0"},{color:"white",translate:"class.scout.dodge.lore.1"},{color:"white",translate:"class.scout.dodge.lore.2"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
