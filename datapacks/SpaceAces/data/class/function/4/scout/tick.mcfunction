...
# Passive: Double Jump
#item replace entity @s hotbar.3 with minecraft:turtle_scute[minecraft:item_model="scout/3",minecraft:item_name={color:"white",translate:"adrenaline"},minecraft:lore=[{color:"white","italic":false,translate:"adrenaline_lore1"},{color:"white",translate:"adrenaline_lore2"},{color:"white",translate:"adrenaline_lore3"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
