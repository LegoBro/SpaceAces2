execute if entity @s[tag=standard,team=blue] if entity @e[distance=..15,tag=!invis,sort=nearest,limit=1,team=red] run function class:mechanic/turret/standard
...
execute if entity @s[tag=standard,team=red] if entity @e[distance=..15,tag=!invis,sort=nearest,limit=1,team=blue] run function class:mechanic/turret/standard
execute if entity @s[tag=sniper,team=red] if entity @e[distance=..25,tag=!invis,sort=nearest,limit=1,team=blue] run function class:mechanic/turret/sniper
execute if entity @s[tag=rocket_launcher,team=red] if entity @e[distance=..20,tag=!invis,sort=nearest,limit=1,team=blue] run function class:mechanic/turret/rocket
