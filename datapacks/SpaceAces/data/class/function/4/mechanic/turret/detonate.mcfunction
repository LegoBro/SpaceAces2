...
execute at @n[tag=my_turret] as @e[type=#projectile:players,tag=sab.activePlayer] if score @s id = place_id id facing entity @e[distance=..10,tag=!ignore,tag=!ignore.projectiles] feet run function projectile:boomer/create
