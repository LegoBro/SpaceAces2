...
execute at @n[tag=my_turret] as @a if score @s id = place_id id facing entity @e[distance=..10,tag=!ignore,tag=!ignore.projectiles] feet run function projectile:boomer/create
