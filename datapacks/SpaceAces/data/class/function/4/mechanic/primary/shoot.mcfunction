...
execute as @e[type=minecraft:area_effect_cloud,tag=shotgun,tag=new,sort=nearest,limit=6,distance=..3] at @s run function class:4/mechanic/primary/projectile
