...
summon item_display ~ ~1 ~ {item:{id:stone,components:{item_model:"class/mechanic/drone"}},Tags:["class.deployable","new","class.mechanic.manual_override.drone"],teleport_duration:2}
