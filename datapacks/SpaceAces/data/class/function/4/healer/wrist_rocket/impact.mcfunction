...
execute positioned ^ ^ ^-0.5 as @p[tag=attacker] facing entity @e[distance=1..6,tag=!ignore,tag=!ignore.projectiles] feet positioned ^ ^ ^ run function projectile:boomer/create
