...
summon item_display ~ ~ ~ {Tags:["wrist_rocket","raycast","grenade","ignore.projectiles","new"],teleport_duration:1,item:{id:"paper",components:{item_model:"class/healer/rocket"}}}
