...
item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:item_model="healer/0",minecraft:item_name={translate:"heal_pistol"},minecraft:lore=[{color:"white","italic":false,translate:"heal_pistol_lore"},{color:"white","italic":false,"text":" - damage: 7"},{color:"white","italic":false,"text":" - ammo: 12"},{color:"white","italic":false,"text":" - reload with speed: 1.25s"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
item replace entity @s[scores={reload=0,shoot=1..}] hotbar.0 with minecraft:paper[minecraft:item_model="healer/0",minecraft:item_name={translate:"heal_pistol"},minecraft:lore=[{color:"white","italic":false,translate:"heal_pistol_lore"},{color:"white","italic":false,"text":" - damage: 7"},{color:"white","italic":false,"text":" - ammo: 12"},{color:"white","italic":false,"text":" - reload with speed: 1.25s"}],tooltip_display={hidden_components:["unbreakable"]}]
