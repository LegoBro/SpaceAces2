...
execute store result storage projectile SpreadX float 0.5 run random value -8..8
execute store result storage projectile SpreadY float 0.5 run random value -8..8
