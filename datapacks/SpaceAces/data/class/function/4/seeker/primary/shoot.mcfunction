...
execute as @e[type=minecraft:area_effect_cloud,tag=heavy_shotgun,tag=new,sort=nearest,limit=4,distance=..3] at @s run function class:4/seeker/primary/projectile
