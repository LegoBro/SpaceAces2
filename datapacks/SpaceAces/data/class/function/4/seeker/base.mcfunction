...
item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:item_model="seeker/0",minecraft:item_name={translate:"plasma_spreader"},minecraft:lore=[{color:"white","italic":false,translate:"plasma_spreader_lore"},{color:"white","italic":false,"text":" - damage: 13"},{color:"white","italic":false,"text":" - ammo: 6"},{color:"white","italic":false,"text":" - reload with speed: 4s"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
