...
execute if entity @s[scores={ability.2.cooldown=300}] run function class:shocksmith/energy_sap/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=100}] run function class:shocksmith/energy_sap/deactivate

# Passive
item replace entity @s hotbar.3 with minecraft:turtle_scute[minecraft:item_model="shocksmith/3",minecraft:item_name={color:"white",translate:"energy_dispersion"},minecraft:lore=[{color:"white","italic":false,translate:"energy_dispersion_lore1"},{color:"white",translate:"energy_dispersion_lore2"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
execute if entity @s[scores={energy=20..}] run function class:shocksmith/energy_dispersion/run

scoreboard players set @s maxHealth 150

item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:item_model="shocksmith/0",minecraft:item_name={translate:"shock_hopper"},minecraft:lore=[{color:"white","italic":false,translate:"shock_hopper_lore"},{color:"white","italic":false,"text":" - damage: 15"},{color:"white","italic":false,"text":" - ammo: 6"},{color:"white","italic":false,"text":" - reload with speed: 2.5s"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
item replace entity @s[scores={reload=0,shoot=1..}] hotbar.0 with minecraft:paper[minecraft:item_model="shocksmith/0",minecraft:item_name={translate:"shock_hopper"},minecraft:lore=[{color:"white","italic":false,translate:"shock_hopper_lore"},{color:"white","italic":false,"text":" - damage: 15"},{color:"white","italic":false,"text":" - ammo: 6"},{color:"white","italic":false,"text":" - reload with speed: 2.5s"}],tooltip_display={hidden_components:["unbreakable"]}]
...
execute if score @s shoot matches 1 run function class:shocksmith/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=7..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function class:shocksmith/reload
