...
summon item_display ~ ~ ~ {Tags:["shock_grenade","raycast","grenade","ignore.projectiles","new","projectile.invisible"],teleport_duration:1,item:{id:paper,components:{item_model:"class/shocksmith/grenade"}}}
