...
execute as @e[type=minecraft:area_effect_cloud,tag=shock_grenade_shot,sort=nearest,limit=,distance=..3] at @s run function class:shocksmith/grenade/projectile
