...
execute positioned ^ ^ ^-0.5 as @e[type=#projectile:players,tag=sab.activePlayer,distance=..3] if score @s id = place_id id run function class:4/shocksmith/secondary/self_heal
return 1