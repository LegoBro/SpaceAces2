...
execute as @n[type=#projectile:players,tag=hb,tag=attacker] facing entity @e[distance=1..50,tag=!ignore,tag=!ignore.projectiles] feet positioned ^ ^ ^ run function projectile:boomer/create
