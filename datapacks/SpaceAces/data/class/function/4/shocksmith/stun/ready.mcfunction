## Stun
item replace entity @s hotbar.2 with minecraft:carrot_on_a_stick[minecraft:item_model="class/shocksmith/stun",minecraft:item_name={color:"white",translate:"class.shocksmith.stun"},minecraft:lore=[{color:"white","italic":false,translate:"class.shocksmith.stun.lore.1"},{color:"white",translate:"class.shocksmith.stun.lore.2"}],minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
execute if score @s SelectedItem matches 2 run item replace entity @s weapon.offhand with emerald[item_model="class/shocksmith/left_arm_stun",item_name="",tooltip_display={hide_tooltip:true}]
