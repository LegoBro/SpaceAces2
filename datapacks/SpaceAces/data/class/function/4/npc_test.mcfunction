...
execute if score @s sab.botTargetEntityID matches 1.. run scoreboard players set @s rightClick 1
execute unless score @s reload matches 1.. run scoreboard players set @s SelectedItem 0
execute if score @s reload matches 1.. run scoreboard players set @s SelectedItem 1
