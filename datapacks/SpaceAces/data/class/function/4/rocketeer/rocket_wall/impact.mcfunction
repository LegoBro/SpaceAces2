...
execute positioned ^ ^ ^-0.5 as @p[tag=attacker] facing entity @e[distance=1..5,tag=!ignore,tag=!ignore.projectiles,tag=!is_on_team] feet positioned ^ ^ ^ run function projectile:boomer/create
