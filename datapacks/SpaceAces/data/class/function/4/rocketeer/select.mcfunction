...
scoreboard players operation @s health = class.rocketeer.health Numbers
...
data modify storage class:scale scale set from storage space_aces:class rocketeer.scale
