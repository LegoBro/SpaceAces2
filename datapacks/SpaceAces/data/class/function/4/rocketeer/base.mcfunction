...
item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:item_model="rocketeer/0",minecraft:item_name={translate:"rocket_launcher"},minecraft:lore=[{color:"white","italic":false,translate:"rocket_launcher_lore"},{color:"white","italic":false,"text":" - damage: 10"},{color:"white","italic":false,"text":" - ammo: 4"},{color:"white","italic":false,"text":" - reload with speed: 2.5s"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
