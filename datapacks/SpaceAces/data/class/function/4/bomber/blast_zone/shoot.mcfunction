summon item_display ^-0.5 ^-0.3 ^ {Tags:["plasma_grenade","raycast","grenade","ignore.projectiles","new","projectile.invisible"],teleport_duration:2,item:{id:paper,components:{item_model:"class/bomber/grenade"}}}
