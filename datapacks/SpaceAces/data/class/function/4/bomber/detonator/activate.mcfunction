...
execute as @e[type=minecraft:item_display,tag=standby_sticky_bomb,sort=nearest] at @s positioned ~ ~0.1 ~ if score @s id = place_id id run function class:4/bomber/detonator/detonate
