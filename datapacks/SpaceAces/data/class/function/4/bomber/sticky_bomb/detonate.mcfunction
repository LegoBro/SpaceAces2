...
execute as @n[type=#projectile:players,tag=sab.activePlayer,tag=attacker] facing entity @e[distance=1..6,tag=!ignore,tag=!ignore.projectiles] feet positioned ^ ^ ^ run function projectile:boomer/create
