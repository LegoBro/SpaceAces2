## Toggle is ready
item replace entity @s hotbar.2 with minecraft:carrot_on_a_stick[minecraft:item_model="class/bomber/toggle",minecraft:item_name={color:"white",translate:"class.bomber.toggle"},minecraft:lore=[{color:"white","italic":false,translate:"class.bomber.toggle.lore.1"},{color:"white",translate:"class.bomber.toggle.lore.2"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
