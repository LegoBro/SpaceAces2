...
execute positioned ^ ^ ^-0.5 as @e[type=#projectile:players,tag=hb] if score @s id = place_id id facing entity @e[distance=..5,tag=hb,tag=!is_on_team] feet run function projectile:boomer/create
return 1
