...
execute anchored eyes run summon item_display ^-0.5 ^-0.3 ^ {Tags:["rifle","raycast","new","laser","projectile.invisible"],item:{id:paper,components:{item_model:"class/soldier/laser"}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},teleport_duration:1,billboard: "center", brightness:{block:15,sky:15}}
