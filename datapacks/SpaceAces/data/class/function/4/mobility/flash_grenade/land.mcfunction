...
execute as @a[distance=..3] unless score @s Team = #Team Team run effect give @s darkness 5 0 true
execute as @a[distance=..3] unless score @s Team = #Team Team run effect give @s blindness 3 0 true
kill @s
