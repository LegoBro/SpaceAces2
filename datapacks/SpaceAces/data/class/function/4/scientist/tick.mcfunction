...
execute unless score @s SelectedItem matches 1 run item replace entity @s weapon.offhand with emerald[item_model="class/scientist/left_arm",item_name="",tooltip_display={hide_tooltip:true}]
