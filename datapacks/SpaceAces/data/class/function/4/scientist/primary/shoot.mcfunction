...
summon item_display ^-0.9 ^0.9 ^ {Tags:["chem","raycast","grenade","ignore.projectiles","new","projectile.invisible"],teleport_duration:2,item:{id:paper,components:{item_model:"class/scientist/laser"}}}
summon item_display ^-0.9 ^0.9 ^ {Tags:["chem","raycast","grenade","ignore.projectiles","new","projectile.invisible"],teleport_duration:2,item:{id:paper,components:{item_model:"class/scientist/laser"}}}
summon item_display ^-0.9 ^0.9 ^ {Tags:["chem","raycast","grenade","ignore.projectiles","new","projectile.invisible"],teleport_duration:2,item:{id:paper,components:{item_model:"class/scientist/laser"}}}
