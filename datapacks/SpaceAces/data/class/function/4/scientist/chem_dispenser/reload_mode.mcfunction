...
execute if score @s i >= class.scientist.1.reload_rate Numbers run scoreboard players set @s i 0
...
scoreboard players operation @a[tag=class.target,scores={reload=1..}] reload += class.scientist.1.reload_amount Numbers
