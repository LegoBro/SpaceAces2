...
execute if entity @s[scores={ability.1.cooldown=0}] run item replace entity @s hotbar.1 with minecraft:carrot_on_a_stick[minecraft:item_model="pyro/1",minecraft:item_name={color:"white",translate:"fire_bomb"},minecraft:lore=[{color:"white","italic":false,translate:"fire_bomb_lore1"},{color:"white",translate:"fire_bomb_lore2"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
...
execute if entity @s[scores={ability.1.cooldown=300}] run function class:pyro/fire_bomb/activate
scoreboard players remove @s[scores={ability.1.cooldown=1..}] ability.1.cooldown 1
execute if entity @s[scores={ability.1.cooldown=200}] run function class:pyro/fire_bomb/deactivate

execute if entity @s[scores={ability.2.cooldown=0}] run item replace entity @s hotbar.2 with minecraft:carrot_on_a_stick[minecraft:item_model="pyro/2",minecraft:item_name={color:"white",translate:"immunity"},minecraft:lore=[{color:"white","italic":false,translate:"immunity_lore1"},{color:"white",translate:"immunity_lore2"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
...
execute if entity @s[scores={ability.2.cooldown=240}] run function class:pyro/immunity/activate
scoreboard players remove @s[scores={ability.2.cooldown=1..}] ability.2.cooldown 1
execute if entity @s[scores={ability.2.cooldown=140}] run function class:pyro/immunity/deactivate

# Passive
item replace entity @s hotbar.3 with minecraft:turtle_scute[minecraft:item_model="pyro/3",minecraft:item_name={color:"white",translate:"turn_up"},minecraft:lore=[{color:"white","italic":false,translate:"turn_up_lore1"},{color:"white",translate:"turn_up_lore2"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
execute if score @s fire matches 1.. run effect give @s minecraft:speed 1 1 true

scoreboard players set @s maxHealth 300

item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:item_model="pyro/0",minecraft:item_name={translate:"hot_air_blower"},minecraft:lore=[{color:"white","italic":false,translate:"hot_air_blower_lore"},{color:"white","italic":false,"text":" - damage: 5"},{color:"white","italic":false,"text":" - ammo: 25"},{color:"white","italic":false,"text":" - reload with speed: 5s"}],minecraft:unbreakable={show_in_tooltip:0b},tooltip_display={hidden_components:["unbreakable"]}]
item replace entity @s[scores={reload=0,shoot=1..}] hotbar.0 with minecraft:paper[minecraft:item_model="pyro/0",minecraft:item_name={translate:"hot_air_blower"},minecraft:lore=[{color:"white","italic":false,translate:"hot_air_blower_lore"},{color:"white","italic":false,"text":" - damage: 5"},{color:"white","italic":false,"text":" - ammo: 25"},{color:"white","italic":false,"text":" - reload with speed: 5s"}],tooltip_display={hidden_components:["unbreakable"]}]
...
execute if score @s shoot matches 1 run function class:pyro/shoot
scoreboard players add @s[scores={shoot=1..}] shoot 1
scoreboard players set @s[scores={shoot=3..}] shoot 0
scoreboard players add @s[scores={totalShots=..0,reload=0}] reload 1
execute if score @s reload matches 1.. run function class:pyro/reload
