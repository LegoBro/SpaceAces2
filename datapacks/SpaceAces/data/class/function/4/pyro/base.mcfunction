...
item replace entity @s[scores={reload=0,shoot=0}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:item_model="pyro/0",minecraft:item_name='{"translate":"hot_air_blower"}',minecraft:lore=['{"color":"white","italic":false,"translate":"hot_air_blower_lore"}','{"color":"white","italic":false,"text":" - damage: 5"}','{"color":"white","italic":false,"text":" - ammo: 25"}','{"color":"white","italic":false,"text":" - reload with speed: 5s"}'],minecraft:unbreakable={show_in_tooltip:0b},minecraft:hide_additional_tooltip={}]
item replace entity @s[scores={reload=0,shoot=1..}] hotbar.0 with minecraft:paper[minecraft:item_model="pyro/0",minecraft:item_name='{"translate":"hot_air_blower"}',minecraft:lore=['{"color":"white","italic":false,"translate":"hot_air_blower_lore"}','{"color":"white","italic":false,"text":" - damage: 5"}','{"color":"white","italic":false,"text":" - ammo: 25"}','{"color":"white","italic":false,"text":" - reload with speed: 5s"}'],minecraft:hide_additional_tooltip={}]
