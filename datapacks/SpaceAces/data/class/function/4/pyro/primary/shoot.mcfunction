...
execute if score @s fire matches 1.. unless score @s reload matches 1.. run summon item_display ~ ~ ~ {Tags:["hot_air","raycast","grenade","ignore.projectiles","new"],teleport_duration:1}
