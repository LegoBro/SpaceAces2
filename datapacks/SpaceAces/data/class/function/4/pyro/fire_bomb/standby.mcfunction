...
execute if entity @s[tag=blue] as @e[distance=..3,team=red] run function class:pyro/fire_bomb/damage
execute if entity @s[tag=red] as @e[distance=..3,team=blue] run function class:pyro/fire_bomb/damage
