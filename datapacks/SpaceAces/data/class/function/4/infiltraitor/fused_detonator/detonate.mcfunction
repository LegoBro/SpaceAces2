...
execute positioned ~ ~ ~ as @e[type=#projectile:players,tag=sab.activePlayer] if score @s id = place_id id facing entity @e[distance=..8,tag=!ignore,tag=!ignore.projectiles] feet positioned ^ ^ ^ run function projectile:boomer/create
kill @s
return 1