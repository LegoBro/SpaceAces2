...
execute if score @s[tag=input.forward] ability.1.cooldown matches ..0 run function class:4/gunner/photon_rush/ready
execute if score @s[tag=!input.forward] ability.1.cooldown matches ..0 run function class:4/gunner/photon_rush/unready
