...
execute if entity @a[tag=in_game] unless score Gamemode settings matches 4 run tp @s[x=7,y=195,z=27,dx=2,dy=3,dz=2] 20043 10 -50
execute if entity @a[tag=in_game] if score Gamemode settings matches 4 run tp @s[x=7,y=195,z=27,dx=2,dy=3,dz=2] 30015 15 15
