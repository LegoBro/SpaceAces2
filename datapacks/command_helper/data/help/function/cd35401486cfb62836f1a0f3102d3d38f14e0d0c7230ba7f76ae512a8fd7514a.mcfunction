...
#return run title @s actionbar [{"translate":"space.-154","with":[""]},{"nbt":"text","storage":"health:bar","source":"storage","type":"nbt"},{"translate":"space.-108","with":[""]},{"nbt":"safe_nbt_interpret.v0","storage":"help:data","interpret":false,"source":"storage","type":"nbt"}]