...
data modify block ~ ~ ~-2 front_text.messages[1] set value '{"text":"[End Mission]","color":"dark_red","bold":true,"clickEvent":{"action":"run_command","value":"/advancement grant @s through training:scout"},"type":"text"}'
