...
execute if entity @e[type=minecraft:villager,tag=pilot,tag=randomClass] run tellraw @a ["",{"text":"Random classes enabled","color":"green","type":"text"}]
execute if entity @e[type=minecraft:villager,tag=pilot,tag=!randomClass] run tellraw @a ["",{"text":"Random classes disabled","color":"red","type":"text"}]
