...
setblock 29978 35 -4 minecraft:oak_wall_sign[facing=east]{front_text:{messages:['""','{"translate":"unlock","clickEvent":{"action":"run_command","value":"/function gamemode:escape/purchase/main_panel"}}','{"translate":"main_panel"}','{"text":"100 Energy","color":"green","type":"text"}']}} replace
...
setblock 29988 34 10 minecraft:oak_wall_sign[facing=north]{front_text:{messages:['""','{"translate":"unlock","clickEvent":{"action":"run_command","value":"/function gamemode:escape/purchase/med_bay"}}','{"translate":"med_bay"}','{"text":"75 Energy","color":"green","type":"text"}']}} replace
