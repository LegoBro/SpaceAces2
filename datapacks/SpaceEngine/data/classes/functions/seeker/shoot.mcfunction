...
execute if entity @s[nbt={ActiveEffects:[{Id:26b}]}] store result score @e[type=area_effect_cloud,limit=4,sort=nearest] damageMultiplier run data get entity @s ActiveEffects[{Id:26b}].Amplifier
