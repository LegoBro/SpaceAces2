...
particle flame ~ ~1.5 ~ 0 0 0 0.1 25
scoreboard players operation place_id id = @s id
execute if entity @s[tag=blue] as @e[distance=..3,team=red] run function classes:pyro/fire_bomb/damage
execute if entity @s[tag=red] as @e[distance=..3,team=blue] run function classes:pyro/fire_bomb/damage
execute as @a[distance=..3] if score @s id = place_id id run function classes:pyro/fire_bomb/damage
