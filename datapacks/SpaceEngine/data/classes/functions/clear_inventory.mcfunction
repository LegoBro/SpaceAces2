...
execute unless entity @s[scores={over_heal=1..}] run item replace entity @s hotbar.5 with air
item replace entity @s[nbt=!{ActiveEffects:[{Id:26b}]}] hotbar.6 with air
execute if entity @s[nbt=!{ActiveEffects:[{Id:1b}]}] run item replace entity @s[nbt=!{ActiveEffects:[{Id:2b}]}] hotbar.7 with air
execute unless entity @s[scores={invis=1..}] run item replace entity @s[nbt=!{ActiveEffects:[{Id:24b}]}] hotbar.4 with air
