...
execute if entity @s[scores={crouching=0}] run tp @e[tag=rifle,sort=nearest,limit=1] ~ ~1.6 ~ ~ ~
execute if entity @s[scores={crouching=1..}] run tp @e[tag=rifle,sort=nearest,limit=1] ~ ~1.26 ~ ~ ~
