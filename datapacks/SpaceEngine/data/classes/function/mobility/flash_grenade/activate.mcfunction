...
execute if entity @s[scores={crouching=0}] run tp @e[tag=flash_grenade,sort=nearest,limit=1] ~ ~.6 ~ ~ ~
execute if entity @s[scores={crouching=1}] run tp @e[tag=flash_grenade,sort=nearest,limit=1] ~ ~.26 ~ ~ ~
execute store result score @e[tag=flash_grenade,sort=nearest,limit=1] id run scoreboard players get @s id
execute as @e[tag=flash_grenade,sort=nearest,limit=1] at @s positioned ~ ~1.25 ~ run function classes:mobility/flash_grenade/projectile
