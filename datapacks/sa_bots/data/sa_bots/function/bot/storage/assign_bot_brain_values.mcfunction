...
#skill
execute store result score #random sab.var run data get storage sa_bots:bot_data this.settings.brain.skill.actual
...
execute store result storage sa_bots:bot_data this.settings.brain.skill.actual int 1 run scoreboard players get #random sab.var

#aggression
execute store result score #random sab.var run data get storage sa_bots:bot_data this.settings.brain.aggression.actual
...
execute if score #min sab.var < #max sab.var run function sa_bots:bot/utility/pick_random_number_min_max
execute store result storage sa_bots:bot_data this.settings.brain.aggression.actual int 1 run scoreboard players get #random sab.var

#cooperativeness
execute store result score #random sab.var run data get storage sa_bots:bot_data this.settings.brain.cooperativeness.actual
...
execute if score #min sab.var < #max sab.var run function sa_bots:bot/utility/pick_random_number_min_max
execute store result storage sa_bots:bot_data this.settings.brain.cooperativeness.actual int 1 run scoreboard players get #random sab.var
