...
#macro agrgument
$data modify storage sa_bots:generic operation set value "$(operation)"

#use generic command
data modify storage sa_bots:generic command set value "function sa_bots:bot/utility/bot_data_set_macro with storage sa_bots:generic"
