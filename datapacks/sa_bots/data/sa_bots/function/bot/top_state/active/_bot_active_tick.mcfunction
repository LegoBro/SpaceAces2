...
function sa_bots:bot/top_state/active/find_bot_entity with storage sa_bots:generic
#--------------------

#bot missing? try to cope
execute if score #bot_exists sab.var matches 0 run function sa_bots:bot/top_state/active/missing/_bot_missing_tick