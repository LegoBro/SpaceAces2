...
execute if entity @s[tag=!sab.botShootingFriendlyPlayer,scores={sab.lockedOntoEnemy=3..,sab.botSkill=..4}] run function sa_bots:bot/class_logic/use_primary
execute if entity @s[tag=!sab.botShootingFriendlyPlayer,scores={sab.lockedOntoEnemy=1..,sab.botSkill=5..}] run function sa_bots:bot/class_logic/use_primary
...
execute if entity @s[tag=!sab.botShootingFriendlyPlayer,scores={sab.lockedOntoEnemy=3..,ability.1.cooldown=800..,ability.1.cooldown=1..}] \
    if function sa_bots:bot/class_logic/random_chance_10hz_skill_based run function sa_bots:bot/class_logic/use_ability_2


#throw grenade at teammate
execute if entity @s[tag=sab.botShootingFriendlyPlayer,scores={sab.lockedOntoEnemy=3..}] run function sa_bots:bot/class_logic/use_ability_1
...
execute if score @s ultimate_charge >= class.shocksmith.ultimate.charge Numbers \
    if entity @s[tag=!sab.botShootingFriendlyPlayer,scores={sab.lockedOntoEnemy=3..}] \
