...
scoreboard players set @s sab.menuPage 3
...
execute if entity @s[scores={sab.signal=0..,sab.waypointEditFocus=1..}] run function sa_bots:editor/utility/run_command_waypoint_short_macro \
    {player_score:"@s sab.waypointEditFocus",command:"function sa_bots:editor/menu/edit/node_interpret_signal_connection",context:"as"}
...
#look up connection data on the selected node
...
execute if score @s sab.waypointEditFocus matches 1.. run function sa_bots:editor/utility/run_command_waypoint_short_macro \
    {player_score:"@s sab.waypointEditFocus",command:"function sa_bots:editor/menu/edit/node_return_data_connections",context:"as"}
